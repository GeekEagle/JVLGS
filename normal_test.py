...
parser.add_argument('--kernel_size', type=int, default=9, help='kernel size for post-processing')
parser.add_argument('--pth_path', type=str, default='./pretrain/IGS-Few_best.pth')
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        j_f = (f1 + Jaccard) / 2
        print(f'ISG test, Jaccard: {Jaccard}, f1: {f1}, J_F:{j_f}.')
